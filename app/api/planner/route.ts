...
export async function POST(req: Request) {
  try {
    ...
    const systemPromptParts = [
      ...
      "5. FORMATTING: The ONLY markdown you may use is `**bold**`. You MUST wrap every concrete date, time, time range, day-of-week, duration, stop count, price, trip name, AND trip category/tag you mention in `**…**` so the user can scan them at a glance (e.g. **Sun 24 May**, **12:30–14:00**, **3 stops**, **45 min**, **€29**, **E-Bike Tour**, **outdoor**, **family-friendly**). Do NOT bold ordinary words, verbs, or filler. No headings, no bullet points, no numbered lists, no italics, no links.",
